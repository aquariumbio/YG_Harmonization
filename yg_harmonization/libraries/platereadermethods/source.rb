...
module PlateReaderMethods
    ...
    DEFAULT_VOLUME = { qty: 300, units: 'l' }
    ...
    #         table highlight_rc(out_coll, rc_list) { |r, c| "#{(media_vol_mat[r][c]).round(1)} l" }
    #     end
    # end
...
# -------------------------------------------------PlateReaderControl------------------------------------------------------------------#
    ...
    #         # note "If yes, take the calibration plate and place on the plate shaker in the 30C incubator for 5 mins."
    #     end
    ...
    #         check "In a fresh 1.5mL Eppendorf tube, dilute 50l of 1mM Fluorescein Stock into 950l of 1X PBS - Final Concentration [50M]"
    ...
    #         table highlight_rc(cal_plate, pbs_wells) {|r,c| "100l"}
    #     end
    ...
    #         separator
    #         note "From the 50M Fluorescein solution, dispense <b>200l</b> in wells <b>A1, B1, C1, D1</b>"
    #         note "Following the image below, transfer <b>100l</b> of 50M Fluorescein solution in Column 1 to Column 2"
    #         note "Resuspend by pipetting up and down 3X"
    #         note "Repeat until column 11 and discard the remaining <b>100l</b>."
    ...
    #         end
    #     end
    #     cal_plates.shift.location = '4C Fridge'
